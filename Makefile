...
PROJECTS := Proyecto_AYDA raylib

.PHONY: all clean help $(PROJECTS) 

all: $(PROJECTS)

Proyecto_AYDA: raylib
ifneq (,$(Proyecto_AYDA_config))
	@echo "==== Building Proyecto_AYDA ($(Proyecto_AYDA_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f Proyecto_AYDA.make config=$(Proyecto_AYDA_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f Proyecto_AYDA.make clean
